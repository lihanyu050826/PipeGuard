...
- 监控总览、管线趋势、设备资产、告警中心、运维工单、分析报告和数据中心七个功能页面
...
当前共 23 项自动化测试，覆盖正常、警告、严重风险识别，管线查询、泄漏注入、告警确认、工单状态机、设备校准、离线/恢复联动、v1 数据库无损升级、SQLite 重启持久化、审计日志、运营统计、三类 CSV 导出和 Python 3.6 兼容性。
